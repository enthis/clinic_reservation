        ...
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <nav>
                ...
                @else
                    ...
                    {{-- Optionally, add a traditional login link if you have one --}}
                    {{-- <a href="{{ route('login') }}" class="ml-4 text-blue-600 hover:text-blue-800">Login</a> --}}
                @endauth
            </nav>
        </div>
    </header>
    ...
    <main class="flex-grow flex items-center justify-center p-4">
        <div class="container mx-auto bg-white p-8 rounded-lg shadow-lg text-center">
            ...
            @else
                ...
                <a href="{{ route('auth.google') }}" class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 transition duration-300 transform hover:scale-105">
